...
class trademarkservicespage extends Component {
    render() {
        return (
            <div>
                <Navigation />
            ...
            <main class="mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16  lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                <h1 class="px-20 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span class="block xl:inline">Manage and Protect
                    
                   
                   
                    <span class="block text-red-600 xl:inline">Your Business & Brand</span> Identity </span> 
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-20 lg:w-1/3">
          <img class="h-56 w-full  sm:h-64 md:h-96 lg:w-full lg:h-full object-contain" src="images/trademark-main.jpg" alt="" />
        </div>
      </div>
                          ...
                          <div class="container px-5 py-6 mx-auto">
                            <div class="flex flex-wrap w-full mb-20">
                              <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">TRADEMARK SERVICES</h1>
      ...
      <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
        ...
        <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          ...
          <a href="/">
            ...
            </span>Filing Package Preparations
          </a>
      ...
      <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
        ...
        <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          <a href="/">
            ...
            </span>Registration And Maintenance
          </a>
          <a href="/">
            <span class="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="w-3 h-3" viewBox="0 0 24 24">
      ...
      <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
        ...
        <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          <a href="/">
            ...
            </span>Trademark Availability Search
          </a>
        ...
        <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
          ...
          <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
            <a href="/">
              ...
              </span>Trademark Prosecution In India
            </a>
            <a href="/">
              <span class="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="w-3 h-3" viewBox="0 0 24 24">
        ...
        <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
          ...
          <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
            <a href="/">
              ...
              </span>Publication/Advertisement
            </a>
        ...
        <div class="p-4 lg:w-1/4 sm:w-1/2 w-full">
          ...
          <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
            <a href="/">
              ...
              </span>Comprehensive e-Filing of Trademark
            </a>
