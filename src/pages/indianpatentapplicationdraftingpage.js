...
class indianpatentapplicationdraftingpage extends Component {
    render() {
        return (
            <div>
                <Navigation />
            ...
            <main class="mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16  lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                <h1 class="px-20 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span class="block xl:inline">Indian Patent               
                    <span class="block text-red-600 xl:inline">Application Drafting</span> </span> 
