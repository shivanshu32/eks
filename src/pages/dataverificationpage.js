    ...
    render() {
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-20 lg:w-1/3">
          <img class="h-56 w-full  sm:h-64 md:h-96 lg:w-full lg:h-full object-contain" src="images/banner-patent.jpg" alt="" />
						...
						Whenever there is a transfer of patent assets during a merger or acquisition or patent sale etc., it is prudent to validate data for patents being acquired, for example, checking the ownership details and ownership history, the maintenance fees paid, patent family details, the bibliographic details etc. Also, the ownership of the patents needs to be changed, which involves preparing of relevant forms to be filed with PTOs. This is a time intensive task, which under the pressing deadlines, becomes unmanageable for the companies and law firms with limited Paralegals juggling with multiple things.
						<br />
						<br />

Our paralegal team helps such clients with data verification needs. The team is well versed in varied requirements of different jurisdictions, and has the ability to deliver quality results under pressing timelines. The team is well versed with the regional laws and provides support for Assignment and IP recordal support services in a variety of jurisdictions across the globe.
<br />
<br />

To help clients cut the overall costs, we offer a variety of engagements models including, hourly models wherein a client is charged based on the number of hours spent, fixed cost models wherein we estimate the total work and provide a fixed fee quote before initiating the work, and Full-Time-Equivalent (FTE) model wherein Law firms and Corporations working on such tasks on a recurring basis, have the option of having a dedicated team working for them.
