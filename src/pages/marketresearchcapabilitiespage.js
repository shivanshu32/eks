          ...
          <div class="sm:text-center lg:text-left">
            <h1 class="px-20 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">Market Research<br />
                <span class="block text-red-600 xl:inline">Capabilities</span> </span> 
...
We liaise with subject matter experts, industry veterans and analysts, who constantly track changing market dynamics. 
Along with global analysis, we also track country wise changes in all industry verticals. 
